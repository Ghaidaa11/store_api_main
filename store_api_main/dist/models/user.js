...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, saltRounds, pepper, query, hash, result, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(query, [u.first_name, u.last_name, hash])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("couldn't create user error: ".concat(err_1));
