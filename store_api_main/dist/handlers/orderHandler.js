...
exports.indexByUserId = exports.create = void 0;
...
var indexByUserId = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orders, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, orderStore.index(parseInt(req.params.user_id))];
            case 2:
                orders = _a.sent();
                console.log(orders);
...
router.get("/:user_id", exports.indexByUserId),
